                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:link action="show" controller='shiroUser' id="${auditLogEventInstance.actor}"><cp:renderShiroUser id='${auditLogEventInstance.actor}'/> </g:link> </td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:link action="show" controller='${controllerName}' id="${auditLogEventInstance.persistedObjectId}">${auditLogEventInstance.persistedObjectId}</g:link> </td>
