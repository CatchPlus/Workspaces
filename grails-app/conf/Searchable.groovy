...
searchable {
     ...
     */
    compassConnection =  compassConnection = System.getProperty( "compass.index.location" )  ? System.getProperty( "compass.index.location" ) :
        new File(
    ...
    defaultMethodOptions = [
            search: [reload: true, escape: false, offset: 0, max: 9999999, defaultOperator: "and"],
            suggestQuery: false//[userFriendly: true]
    ]
